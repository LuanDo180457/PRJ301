...
<html>
    ...
    <body>
        ...
        <form action="<c:url value='/QuanliTaiKhoan'/>" method="post">
            ...
            <input type="password" id="password" name="password" value="${taiKhoan.password}" required>

            <label for="isNhanVien">Is Employee:</label>
            <input type="checkbox" id="isNhanVien" name="isNhanVien" ${taiKhoan.isNhanVien ? 'checked' : ''}>

            <label for="isAdmin">Is Admin:</label>
            <input type="checkbox" id="isAdmin" name="isAdmin" ${taiKhoan.isAdmin ? 'checked' : ''}>
